...
export class SkelettonDecorator implements Drawable {
    name:string
    graph:Graph
...
export class Graph implements Drawable {
    ...
    public cloneWithNewName(name:string):Graph {
        // Inspection going on
        // Create a new instance of the same class (even if it's a subclass)
        // https://stackoverflow.com/questions/42736001/cloning-a-class-instance-in-typescript
        let clone = new (this.constructor as { new (name:string):Graph })(name)
